...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	authService.SetInternalBalanceOrderRecorder(internalBalanceOrderRecorder)
	...
	type internalBalanceOrderRecorderSetter interface {
		SetInternalBalanceOrderRecorder(service.InternalBalanceOrderRecorder)
	}
	if recorderSetter, ok := adminService.(internalBalanceOrderRecorderSetter); ok {
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, handlerInvoiceHandler, availableChannelHandler, idempotencyCoordinator, idempotencyCleanupService)
