...
// SetInternalBalanceOrderRecorder attaches the optional recorder used by local
// administrative balance adjustments. The upstream service decomposition keeps
// this hook for compatibility with the dev branch wiring.
