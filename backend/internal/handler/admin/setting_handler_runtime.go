...
// GetAdminAPIKeyReadOnly returns the read-only administrator API key status.
...
// RegenerateAdminAPIKeyReadOnly creates or replaces the read-only administrator API key.
...
// DeleteAdminAPIKeyReadOnly removes the read-only administrator API key.
