export default {
  ...
  // Setup Wizard
  setup: {
    title: 'TokenCloud Setup',
    description: 'Configure your TokenCloud instance',
    database: {
  ...
  nav: {
    ...
    ops: 'Ops',
    groupMonitor: 'Service Status Monitor',
  ...
  groupMonitor: {
    ...
    refresh: 'Refresh',
    loading: 'Loading...',
    loadFailed: 'Failed to load service status monitor',
    empty: 'No monitorable group service status data',
  ...
  payment: {
    ...
    selectSubscriptionPlan: 'Please select a subscription plan',
    subscriptionOwned: 'Subscribed',
    subscriptionNoDescription: 'No description',
    subscriptionValidityDays: 'Validity: {days} days',
    subscriptionLimitsTitle: 'Subscription Limits',
    subscriptionLimitsDesc: 'API usage under this package is constrained by the following windows:',
    subscriptionLimitDaily: 'Daily Limit',
    subscriptionLimitWeekly: 'Weekly Limit',
    subscriptionLimitMonthly: 'Monthly Limit',
    subscriptionLimitUnlimited: 'Unlimited',
    subscriptionLimitsExplain:
      'Daily, weekly, and monthly windows apply in parallel. Hitting any configured limit will throttle usage until that window resets.',
    ...
    subscriptionApiNotEnabledTitle: 'Subscription plans API not enabled',
    subscriptionApiNotEnabledDesc: 'Subscription plan endpoints are not available in this deployment.',
    myOrders: 'My Orders',
    ...
    orderTypeSubscriptionPurchase: 'Subscription Purchase',
  ...
  auth: {
    ...
    resendCountdown: 'Resend available in {countdown}s',
    ...
    emailSuffixNotAllowedWithAllowed:
      'This email domain is not allowed for registration. Allowed domains: {suffixes}',
  ...
  keys: {
    ...
    rateLimitHint: 'Set spending caps (USD) for each time window. 0 means unlimited.',
    rateLimit5h: '5h Limit',
    rateLimit1d: '1d Limit',
    rateLimit7d: '7d Limit',
    resetRateLimitUsage: 'Reset Rate Usage',
    resetUsage: 'Reset Usage',
    resetNow: 'Resetting soon',
    resetRateLimitTitle: 'Confirm Reset Rate Usage',
    resetRateLimitConfirmMessage: 'Are you sure you want to reset rate usage for key "{name}" to 0? This action cannot be undone.',
    rateLimitResetSuccess: 'Rate usage reset successfully',
    failedToResetRateLimit: 'Failed to reset rate usage',
  ...
  usage: {
    ...
    exporting: 'Exporting...',
    exportingBilling: 'Exporting billing...',
    preparingExport: 'Preparing export...',
    preparingBillingExport: 'Preparing billing export...',
    model: 'Model',
    ...
    billingExportSuccess: 'Billing data exported successfully',
    billingExportFailed: 'Failed to export billing data',
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. tokencloud-backups), choose a region',
    ...
    groups: {
      ...
      subscription: {
        ...
        validityDaysShort: '{days}d',
        userPurchaseVisible: 'Visible to Users',
        visibleToUsers: 'Visible',
        notVisibleToUsers: 'Hidden',
        userPurchasePriceUSD: 'User-side Price (USD)',
        userPurchasePricePlaceholder: 'e.g. 9.90',
        userPurchasePriceHint: 'Amount charged when users purchase this subscription package',
        noLimit: 'No limit'
      },
      imagePricing: {
    ...
    subscriptions: {
      ...
      resetQuotaTitle: 'Confirm Quota Reset',
      resetQuotaConfirm: 'Are you sure you want to reset subscription quotas for {user}? This action cannot be undone.',
      quotaResetSuccess: 'Quota reset successfully',
      revokeConfirm:
    ...
    accounts: {
      ...
      types: {
        ...
        soraApiKey: 'Sora API Key (Upstream passthrough)',
        soraApiKeyHint: 'Use upstream Base URL + API Key passthrough for Sora APIs',
        upstream: 'Upstream',
      ...
      openai: {
        ...
        wsMode: 'OpenAI WS Mode',
        wsModeDesc: 'Control WebSocket forwarding strategy for OpenAI API Key accounts on Responses API',
        wsModeOff: 'Off (HTTP)',
        wsModeCtxPool: 'Context Pool (Reserved)',
        wsModePassthrough: 'Passthrough (WebSocket)',
      ...
      quotaLimit: 'Account Quota Limit (USD)',
      quotaLimitHint: '0 means unlimited. Over-quota behavior is controlled by allow-overages.',
      quotaLimitToggle: 'Enable Account Quota Limits',
      quotaLimitToggleHint: 'Enable daily/weekly/total quota controls for this account',
      quotaLimitPlaceholder: 'e.g. 100',
      quotaDailyLimit: 'Daily Quota Limit',
      quotaDailyLimitHint: 'Rolling mode: calculated over the last 24 hours',
      quotaDailyLimitHintFixed: 'Fixed mode: resets at {hour}:00 ({timezone}) every day',
      quotaWeeklyLimit: 'Weekly Quota Limit',
      quotaWeeklyLimitHint: 'Rolling mode: calculated over the last 7 days',
      quotaWeeklyLimitHintFixed: 'Fixed mode: resets every {day} at {hour}:00 ({timezone})',
      quotaTotalLimit: 'Total Quota Limit',
      quotaTotalLimitHint: '0 means unlimited; over-limit behavior follows allow-overages',
      ...
      allowOveragesTooltip: 'When enabled, requests can continue after quota is exceeded (for monitoring only).',
      ...
      quotaControl: {
        ...
        rpmLimit: {
          label: 'RPM Limit',
          hint: 'Throttle by requests-per-minute; can be combined with user message queue mode',
          baseRpm: 'Base RPM',
          baseRpmPlaceholder: '60',
          baseRpmHint: 'Base allowed requests per minute',
          strategy: 'Rate Strategy',
          strategyTiered: 'Tiered Throttle',
          strategyTieredHint: 'Apply stepped throttling after limit is reached',
          strategyStickyExempt: 'Sticky Session Exempt',
          strategyStickyExemptHint: 'Sticky sessions bypass RPM throttling',
          stickyBuffer: 'Sticky Buffer',
          stickyBufferPlaceholder: '5',
          stickyBufferHint: 'Extra RPM reserved for sticky sessions',
          userMsgQueue: 'User Message Queue Mode',
          userMsgQueueHint: 'Queue user requests to reduce burst 429 errors',
          umqModeOff: 'Off',
          umqModeThrottle: 'Throttle Queue',
          umqModeSerialize: 'Serialize Queue'
        },
        sessionLimit: {
        ...
        sessionIdMasking: {
          ...
          hint: 'When enabled, keeps the metadata session identifier fixed for 15 minutes so upstream treats requests as the same session'
        },
        cacheTTLOverride: {
      ...
      loadFactorHint: 'Fine-tune scheduling weight. Higher values are preferred more often.',
      poolMode: 'Pool Mode',
      poolModeHint: 'Enable pooled scheduling and retry flow',
      poolModeInfo: 'Requests will run through pooled flow with retry and sticky-session exemptions',
      poolModeRetryCount: 'Retry Count',
      poolModeRetryCountHint: 'Only applies in pool mode; max retry attempts per request',
      ...
      soraUpstreamBaseUrlHint: 'Fill in Sora upstream-compatible endpoint, e.g. https://api.openai.com',
      soraBaseUrlRequired: 'Base URL is required for Sora API Key mode',
      soraBaseUrlInvalidScheme: 'Sora Base URL must start with http:// or https://',
      bedrockLabel: 'AWS Bedrock',
      bedrockDesc: 'Connect models via AWS Bedrock using SigV4 or API Key auth',
      bedrockAuthMode: 'Auth Mode',
      bedrockAuthModeSigv4: 'SigV4 (Recommended)',
      bedrockAuthModeApikey: 'API Key',
      bedrockAccessKeyId: 'Access Key ID',
      bedrockAccessKeyIdRequired: 'Please enter Access Key ID',
      bedrockSecretAccessKey: 'Secret Access Key',
      bedrockSecretAccessKeyRequired: 'Please enter Secret Access Key',
      bedrockSessionToken: 'Session Token (Optional)',
      bedrockSessionTokenHint: 'Fill this when using temporary credentials',
      bedrockApiKeyInput: 'Bedrock API Key',
      bedrockApiKeyRequired: 'Please enter Bedrock API Key',
      bedrockRegion: 'Region',
      bedrockRegionHint: 'e.g. us-east-1',
      bedrockForceGlobal: 'Force Global Endpoint',
      bedrockForceGlobalHint: 'When enabled, prefer global endpoint over region-specific endpoint',
      // OAuth flow
      oauth: {
    ...
    announcements: {
      ...
      form: {
        ...
        status: 'Status',
        notifyMode: 'Notify Mode',
        notifyModeHint: 'Popup displays immediately when user opens the page; Silent only appears in the announcement list.',
        startsAt: 'Starts At',
        endsAt: 'Ends At',
    ...
    ops: {
      ...
      upstreamRate: 'Upstream error rate:',
      ...
      systemLog: {
        title: 'System Logs',
        description: 'Newest first. Supports filtering, search, and cleanup by current conditions.',
        queue: 'Queue',
        written: 'Written',
        dropped: 'Dropped',
        failed: 'Failed',
        runtimeConfig: 'Runtime Log Config',
        loading: 'Loading...',
        level: 'Level',
        ...
        saveFailed: 'Failed to save runtime log config',
        resetDefaults: 'Reset Defaults',
        resetConfirm: 'Reset runtime log config to startup values (env/yaml) and apply now?',
        resetSuccess: 'Runtime log config reset to startup values',
        resetFailed: 'Failed to reset runtime log config',
        recentWriteError: 'Latest write error:',
        timeRange: 'Time Range',
        ...
        model: 'Model',
        keyword: 'Keyword',
        keywordPlaceholder: 'Message / Request ID',
        apply: 'Search',
        reset: 'Reset',
        cleanupByFilters: 'Clean Matching Logs',
        cleanupConfirm: 'Delete system logs that match the current filters? This cannot be undone.',
        cleanupSuccess: 'Cleanup finished. Deleted {count} logs.',
        cleanupFailed: 'Failed to clean system logs',
        refreshHealth: 'Refresh Health',
        fetchFailed: 'Failed to load system logs',
        loadingLogs: 'Loading...',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for TokenCloud end-user login',
      ...
      gatewayForwarding: {
        ...
        metadataPassthroughHint: 'Pass through the client\'s original metadata user identifier without rewriting. May improve upstream cache hit rates.',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'TokenCloud',
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: 'TokenCloud',
        useTls: 'Use TLS',
      ...
      rectifier: {
        ...
        thinkingBudgetHint: 'Automatically set the thinking budget to 32000 and retry when upstream reports the minimum budget limit error (>=1024)',
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to TokenCloud',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the TokenCloud AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
  ...
  modelPricing: {
    ...
    rateSection: 'Model Rate',
    fullFormula: 'Full Formula',
    fullFormulaText: 'Official price (input tokens × input price + output tokens × output price + cache creation × price + cache read × price) × channel discount',
    fullFormulaNote: '(For reference only, not used in actual billing)',
    officialPrice: 'Official Pricing',
    officialPriceHint: 'Please refer to the official website for pricing details',
