export default {
  ...
  payment: {
    title: 'Recharge',
    description: 'Top up your balance to keep your API running smoothly.',
    resultTitle: 'Payment Result',
    resultDescription: 'View the latest order status and credit delivery.',
    backToPayment: 'Back to Recharge',
    viewOrders: 'View My Orders',
    resultMissingOrder: 'Missing required query param: order. Please create an order first.',
    resultPaidHint: 'Payment is confirmed and credits should be applied. Refresh if needed.',
    resultFailedHint: 'Payment failed. Please go back and try again.',
    resultExpiredHint: 'Order expired. Please create a new order.',
    resultPendingHint: 'Order is still pending. Click refresh to get the latest status.',
    useRedeemCode: 'Use Redeem Code',
    currentBalance: 'Current Balance',
    tip: 'If online payment is not enabled, please contact support.',
    contact: 'Contact',
    ...
    finalPay: 'Final payable amount',
    confirmAmount: 'Confirm amount',
    checkoutTitle: 'Checkout',
    checkoutDesc: 'The system uses USD for display, payment will be settled in CNY.',
    payAmountUsd: 'Amount (USD)',
    payAmountCny: 'Pay (CNY)',
    exchangeRateHint: 'Exchange rate: 1 USD ≈ {rate} CNY',
    calcHint: '${usd} × {rate} × {discount} = ¥{cny}',
    packageTitle: 'Package ${usd}',
    customAmount: 'Custom Amount',
    customAmountDesc: 'Enter the USD amount you want to top up.',
    customAmountPlaceholder: 'e.g. 100',
    customCheckoutTitle: 'Custom Amount',
    customPayHint: 'Estimated to pay: ¥{cny} (rate {rate})',
    invalidAmount: 'Please enter a valid amount',
    apiNotEnabledTitle: 'Payment API not enabled',
    apiNotEnabledDesc:
      'Payment endpoints are not available in this deployment yet. The UI is ready; enable backend routes to activate online recharge.',
    noPlans: 'No plans available',
    defaultPlanDesc: 'Instant top-up. Credits are applied after payment is confirmed.',
    credits: 'credits',
    buy: 'Buy',
    confirmPay: 'Confirm & Create Order',
    channelWipHint: 'Payment channels are WIP. Orders can be created, but pay URL/QR will be added later.',
    creatingOrder: 'Creating order...',
    orderCreated: 'Order created',
    apiNotEnabledToast: 'Payment API not enabled yet',
    myOrders: 'My Orders',
    ordersApiNotEnabledTitle: 'Orders API not enabled',
    ordersApiNotEnabledDesc:
