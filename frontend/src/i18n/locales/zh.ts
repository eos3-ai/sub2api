export default {
  ...
  // Setup Wizard
  setup: {
    title: 'TokenCloud 安装向导',
    description: '配置您的 TokenCloud 实例',
    database: {
      title: '数据库配置',
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: '点击「创建存储桶」，输入名称（如 tokencloud-backups），选择区域',
          line3: '点击创建完成'
        },
        step2: {
          title: '创建 API 令牌',
    ...
    ops: {
      ...
      settings: {
        ...
        ignoreInvalidApiKeyErrors: '忽略 API Key 鉴权错误',
        ignoreInvalidApiKeyErrorsHint: '启用后，无效、缺失或已禁用 API Key 的错误（INVALID_API_KEY、API_KEY_REQUIRED、API_KEY_DISABLED）将不会写入错误日志。',
        ignoreInsufficientBalanceErrors: '忽略余额不足错误',
        ignoreInsufficientBalanceErrorsHint: '启用后，余额不足、账号余额不足或额度不足错误将不会写入错误日志。',
        autoRefresh: '自动刷新',
        enableAutoRefresh: '启用自动刷新',
        ...
        displayAlertEvents: '显示告警事件卡片',
        displayAlertEventsHint: '在运维监控仪表板中显示告警事件卡片。',
        displayOpenAITokenStats: '显示 OpenAI Token 统计卡片',
        displayOpenAITokenStatsHint: '在运维监控仪表板中显示 OpenAI Token 请求统计卡片。',
        validation: {
          title: '请先修正以下问题',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 TokenCloud 用户登录',
  ...
  onboarding: {
    ...
    admin: {
      ...
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 TokenCloud 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 TokenCloud',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 TokenCloud AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
