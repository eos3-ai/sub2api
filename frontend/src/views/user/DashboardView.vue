...
import UserDashboardAnnouncements from '@/components/user/dashboard/UserDashboardAnnouncements.vue'; import UserDashboardQuickActions from '@/components/user/dashboard/UserDashboardQuickActions.vue'
...
const refreshAll = async () => { await Promise.all([loadStats(), loadCharts()]) }

onMounted(() => { loadStats(); loadCharts() })
</script>
