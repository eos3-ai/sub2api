<template>
  ...
  <div
    v-else
    class="relative flex min-h-screen flex-col overflow-hidden bg-[#f4f1ea] dark:bg-dark-950"
  >
...
const siteName = computed(() => appStore.cachedPublicSettings?.site_name || appStore.siteName || 'TokenCloud')
...
:deep(.dark) .terminal-window {
  box-shadow:
    ...
    0 0 0 1px rgba(196, 74, 44, 0.2),
    0 0 40px rgba(196, 74, 44, 0.1),
    inset 0 1px 0 rgba(255, 255, 255, 0.1);
}
</style>
