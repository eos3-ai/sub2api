      ...
      <template #filters>
        <div class="flex flex-wrap items-center gap-3">
          ...
          <div class="flex flex-wrap items-center justify-end gap-2">
            ...
            <button v-if="!isOperator" @click="showCreateModal = true" class="btn btn-primary flex-1 md:flex-initial">
        ...
        <DataTable :columns="columns" :data="users" :loading="loading" :actions-count="7">
          ...
          <template #cell-status="{ value }">
            <div class="flex items-center gap-1.5">
              ...
              <span class="text-sm text-gray-700 dark:text-gray-300">
                {{ t('common.' + (value === 'disabled' ? 'inactive' : value)) }}
              </span>
            </div>
          </template>
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button
                v-if="!isOperator && row.role !== 'admin'"
        ...
        <div class="py-1">
          <template v-for="user in users" :key="user.id">
            <template v-if="user.id === activeMenuId">
              ...
              <button
                v-if="!isOperator && user.role !== 'admin'"
